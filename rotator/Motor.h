/*
 * NOTE(lmr): This is a "fork" of the Stepper arduino library that I've modified
 * for my purposes.
 *
...
class Motor {
  ...
  private:
    ...
    unsigned int steps_per_revolution;      // steps per revolution
    int target;                    // the target stup number
    int current;
    int min;
    int max;
